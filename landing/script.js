(() => {
  ...
  ------------------------------------------------------------------- */
  // Prefer an optional local override (landing/config.js sets window.ARBITER_API_BASE).
  // Fall back to production so opening the page with no override is unchanged.
  const API_BASE =
